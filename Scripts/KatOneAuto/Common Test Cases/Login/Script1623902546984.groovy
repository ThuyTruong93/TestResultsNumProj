...
'Fill username'
WebUI.setText(findTestObject('Object Repository/KatOne/Page_Katalon One/Login/input_Email_email'), var_username)

'Fill password'
WebUI.setText(findTestObject('Object Repository/KatOne/Page_Katalon One/Login/input_Password_password'), var_password)
